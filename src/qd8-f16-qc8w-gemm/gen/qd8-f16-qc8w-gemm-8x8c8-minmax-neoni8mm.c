...
void xnn_qd8_f16_qc8w_gemm_minmax_ukernel_8x8c8__neoni8mm(
    size_t mr,
    size_t nc,
    size_t kc,
    ...
    const struct xnn_qd8_quantization_params quantization_params[restrict XNN_MIN_ELEMENTS(1)]) XNN_OOB_READS
{
  ...
  do {
    ...
    if XNN_LIKELY(nc >= 8) {
      ...
      if (nc & 2) {
        vst1_lane_f32((void*) c7, vreinterpret_u32_f16(vfp16out7x0123), 0);  c7 += 2;
        vst1_lane_f32((void*) c6, vreinterpret_u32_f16(vfp16out6x0123), 0);  c6 += 2;
        vst1_lane_f32((void*) c5, vreinterpret_u32_f16(vfp16out5x0123), 0);  c5 += 2;
        vst1_lane_f32((void*) c4, vreinterpret_u32_f16(vfp16out4x0123), 0);  c4 += 2;
        vst1_lane_f32((void*) c3, vreinterpret_u32_f16(vfp16out3x0123), 0);  c3 += 2;
        vst1_lane_f32((void*) c2, vreinterpret_u32_f16(vfp16out2x0123), 0);  c2 += 2;
        vst1_lane_f32((void*) c1, vreinterpret_u32_f16(vfp16out1x0123), 0);  c1 += 2;
        vst1_lane_f32((void*) c0, vreinterpret_u32_f16(vfp16out0x0123), 0);  c0 += 2;
