    ...
    const union xnn_qu8_hswish_params params[restrict XNN_MIN_ELEMENTS(1)]) XNN_OOB_READS
{
  ...
  const v128_t vmax_val = wasm_i16x8_splat(0x7FFF);
  const v128_t vmin_val = wasm_i16x8_splat(0x8000);
  const v128_t vhalf = wasm_i16x8_splat(0x4000);
  const v128_t vzero = wasm_i16x8_splat(0x0000);
  for (; batch >= 32 * sizeof(uint8_t); batch -= 32 * sizeof(uint8_t)) {
    ...
    const v128_t vy1 = wasm_u8x16_narrow_i16x8(vout2, vout3);
